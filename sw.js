const CACHE='quotation-maker-pro-v15-1';
const CORE=['./','./index.html','./styles.css','./app.js','./email-template.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./favicon-64.png','./apple-touch-icon.png'];
